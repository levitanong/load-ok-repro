...
`src/main/load_ok_repro/client.cljs` contains the code to start and refresh
...
application `load-ok-repro.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/load_ok_repro.jar
```
